...
extension UIColor {
    ...
    class func randomColorForCardViewCell() -> UIColor {
        ...
        let colorArr: [UIColor] = [lightRed!, lightBlue!, lightGray!, indigo!, green!, yellow!, deepOrange!]
        let randomNumber = arc4random_uniform(UInt32(colorArr.count))
        
        return colorArr[Int(randomNumber)]
    }
}
